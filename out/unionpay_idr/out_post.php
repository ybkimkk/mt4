...
/*if($_GET['clause'] == 'topay'){
	...
	echo '<input type="hidden" name="confirmsave" value="1">';
	...
	echo '<div class="form-group row">
			<label class="col-sm-2">' , L("银行帐号") , '：</label>
			<div class="col-sm-8">
				<input name="bankaccount1" id="bankaccount1" type="text" class="form-control" value="' , $bank_name['0']['accountNum'] , '" placeholder="银行帐号">
			</div>
		</div>';
	/*
	echo '<div class="form-group row">
