                ...
                <div class="card-body">
                    <form class="form-horizontal" action="?" method="get" id="signupForm">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="inmoney" id="inmoney" type="text" onblur="calInMoney();"
                                       onkeyup="calInMoney();" class="form-control" value=""
                                       placeholder="<?php echo L('请输入金金额'); ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="currency_id" id="currency_id" class='form-control'>
                                    <?php
                                    $payCurrency = $DB->getDTable("select * from t_pay_currency where channel_type is not null and f_status = 1 and f_title like '%_in'");
                                    foreach ($payCurrency as $key => $val) {
                                        echo '<option value="', $val['id'], '">';
                                        echo trim($val['f_title'], "_in");
                                        echo '</option>';
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="inmoney_cal" id="inmoney_cal" type="text" class="form-control" value=""
                                       readonly>
                            </div>
                        </div>
                        <div class="form-group row" style="display:none;">
                            ...
                            <div class="col-sm-8">
                                <input name="inmoney_fee" id="inmoney_fee" type="text" class="form-control" value=""
                                       readonly>
                            </div>
                        </div>
                        <div class="form-group row" style="display:none;">
                            ...
                            <div class="col-sm-8">
                                <input name="inmoney_sum" id="inmoney_sum" type="text" class="form-control" value=""
                                       readonly>
                            </div>
                        </div>
                        <div class="form-group row">
