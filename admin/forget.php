                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="#">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="text" id="account" name="account" placeholder="<?php echo L('注册邮件');?>">
                                    </div>
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-primary" type="button" id="forget"><?php echo L('确认提交');?></button>
                                    </div>
