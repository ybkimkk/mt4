                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
										说明：报表数据库中存放交易手数的字段VOLUME值被放大，“外汇、cfd、指数”被放大100倍，“股票”被放大10000倍，请按实际情况填写放大倍数。
										这将影响赠金的检测运算。
                                    </div> <!-- end card-body -->
                                </div> <!-- end card-->
                            </div> <!-- end col -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="form-horizontal" method="post" action="?clause=savelotb&id=<?php echo $Id;?>">
                                            ...
                                            <div class="form-group col-sm-3">
                                                ...
                                                <div class="col-sm-6"><div class="form-control-static"><input name="f_lotB_<?php echo $val['id'];?>" type="text" value="<?php echo $val['f_lotB'];?>" class="form-control" placeholder=""></div></div>
                                            </div>
                                            <?php
											}
											?>
