                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10"><div class="form-control-static"><?php
													if($DRInfo['Type'] == 'BALANCE_FIRST'){
														echo '<span class="label label-info">' , L('首次入金') , '</span>';
													}else if($DRInfo['Type'] == 'BALANCE_PER'){
														echo '<span class="label label-success">' , L('单笔入金') , '</span>';
													}else if($DRInfo['Type'] == 'REG'){
														echo '<span class="label label-success">' , L('开户') , '</span>';
													}
													echo number_format($DRInfo['Condition'],2,".",","), ' USD';
													echo ' (';
													echo $DRInfo['SetResult'];
													if($DRInfo['Scale'] == 'Scale'){
														echo '%';
													}else if($DRInfo['Scale'] == 'Fixed'){
														echo 'USD';
													}
													echo ')<br>';
													echo $DRInfo['f_fromAbout'];
												?></div></div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-2 control-label"><?php echo L("入金金额");?>（USD）:</label>
                                                <div class="col-sm-10"><div class="form-control-static"><?php echo $DRInfo['InMoney'];?></div></div>
                                            </div>
                                            <div class="form-group row">
