                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title"><?php echo L('出金报表') , getCurrMt4ServerName();?></h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            <form id="commentForm" class="form-inline" novalidate="novalidate" action="?" method="get">
                                                ...
                                                <div class="form-group mr-sm-2 mb-sm-2">
                                                    <select name='searchStatus' class='form-control'>
                                                        <option value=''><?php echo L('入金范围');?></option>
                                                        <option value='1'<?php if($SearchStatus == '1'){echo ' selected';} ?>><?php echo L('CRM入金');?></option>
                                                        <option value='2'<?php if($SearchStatus == '2'){echo ' selected';} ?>><?php echo L('MT平台入金');?></option>
                                                     </select>
                                                </div>
...
$result = getCapitaList(2, $page, $SearchSTime, $SearchETime, $SearchStatus, $member_where['loginID'], $member_where['allMID']);
...
if(FGetInt('isdownload') > 0){
	...
	$objPHPExcel->setActiveSheetIndex(0)->setTitle(L('出金报表'));
...
echo '&nbsp; &nbsp;' , L('总出金笔数') , '：' , $totaldata['totaloutcount'];
?> 
</div>
