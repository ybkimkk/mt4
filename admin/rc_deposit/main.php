                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title"><?php echo L('入金报表') , getCurrMt4ServerName();?></h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
...
$result = getCapitaList(1, $page, $SearchSTime, $SearchETime, $SearchStatus, $member_where['loginID'], $member_where['allMID']);
...
if(FGetInt('isdownload') > 0){
	...
	$objPHPExcel->setActiveSheetIndex(0)->setTitle(L('入金报表'));
...
echo '&nbsp; &nbsp;' , L('总入金笔数') , '：' , $totaldata['totalincount'];
?> 
</div>
