...
<html lang="en">
    ...
    <body class="authentication-bg">
		<style>
		.verify-msg{color:#ff0000;padding-bottom:10px;}
		</style>
...
<div class="dropdown notification-list topbar-dropdown mb-4" style="width:200px;margin:0 auto;">
	<a class="dropdown-toggle arrow-none" data-toggle="dropdown" href="#nolink" role="button" aria-haspopup="false" aria-expanded="false" style="padding-left:10px;">
		<span class="align-middle"><?php echo $LangNameList['list'][$CurrLangName]['title'];?></span> <i class="mdi mdi-chevron-down"></i>
	</a>
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu" style="right:26px;">
		<?php
		foreach($LangNameList['list'] as $key=>$val){
		...
		?>
                                ...
                                <form action="#">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control" type="text" id="account" name="account" placeholder="<?php echo L('请输入邮箱或者MT账号');?>">
                                    </div>
                                    
                                    <div class="form-group">
                                        <input class="form-control" type="password" id="password" name="password" placeholder="<?php echo L('请输入登录密码');?>">
                                    </div>
                                    
                                    <div class="form-group" style="position:relative;">
                                        <img src="/include/vCode/001.php?w=87&h=38" style="position:absolute; top:0px; right:0px;" onClick="this.src='/include/vCode/001.php?w=87&h=38&rnd='+Math.random()">
                                        <input class="form-control" type="text" id="verify" name="verify" placeholder="<?php echo L('请输入验证码');?>">
                                    </div>
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-primary" type="button" id="loginbtn"><?php echo L('登录');?></button>
                                    </div>
