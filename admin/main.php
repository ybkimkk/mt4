...
?>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-lg-<?php if($DRAdmin['userType'] == 'direct' && $webConfig['f_directCanRecom'] <= 0){echo '3';}else{echo '2';}?>">
                            ...
                            <div class="col-lg-2"<?php if($DRAdmin['userType'] == 'direct' && $webConfig['f_directCanRecom'] <= 0){echo ' style="display:none;"';}?>>
                                <div class="card widget-flat">
                                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-xl-<?php if($DRAdmin['userType'] == 'direct' && $webConfig['f_directCanRecom'] <= 0){echo '6';}else{echo '4';}?>">
                                <div class="card">
                                    <div class="card-body">
                            ...
                            <div class="col-xl-<?php if($DRAdmin['userType'] == 'direct' && $webConfig['f_directCanRecom'] <= 0){echo '6';}else{echo '5';}?>">
                                <div class="card">
                                    <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="ibox-content">
                                            <div class="row" style="text-align:center; display:block;">
                                                <div class="col-xs-12">
                                                    <h5><span id='text'><img width="96px" src="<?php echo trim($data['avatar'],'.'); ?>"></span>
...
var barnum = '<?php echo escapeJsonString(json_encode($barnum)); ?>';
 ...
 //dataList是从后台传回来的数据，样式如同[1,3,4,5,6,3,2]，dateList也是从后台传回来的，是一个时间的list，用来做提示显示   
    $('#sparkline').sparkline(data,{type:'bar',width:'42px',height:'28px',barWidth:barnum,barColor: "#1ab394",negBarColor: "#c6c6c6"});
    ...
    $('#sparkline1').sparkline(sdata,{type:'line',width:'42px',height:'28px',lineWidth:1,barColor: "#17997f",negBarColor: "#1ab394"});
