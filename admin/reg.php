...
<head>
    ...
    <script>
        ...
        fbq('init', '386318094125628');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=386318094125628&ev=PageView&noscript=1"
        /></noscript>
    <!-- End Meta Pixel Code -->
</head>
            ...
            <div class="col-lg-5" id="regWapBox">
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        <div class="text-center w-75 m-auto">
                            ...
                            <div class="dropdown notification-list topbar-dropdown mb-4"
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu"
                                    ...
                                    foreach ($LangNameList['list'] as $key => $val) {
                                        if ($key === 'zh-vn') {
                                            echo '<a href="https://trader.am-broker.com/admin/reg.php" class="dropdown-item notify-item"><span class="align-middle">', $val['title'], '</span></a>';
                                        } else {
                        ...
                        <form class="form-horizontal m-t" action="?clause=savereg" method="post" id="signupForm"
                              autocomplete="off">
                            ...
                            if ($check_phone_code == 1) {
                                ...
                                <div class="form-group">
                                    <ul class="nav nav-tabs" style="width:90%;height:50px; margin: auto">
                                        <li class="active" id="agentli"><a data-toggle="tab" href="#tab-1"
                                                                           aria-expanded="false"
                                                                           style='border-radius:none; margin-right:0px;'
                                                                           onClick="javascript: phoneHide()"><?php echo L('邮箱注册'); ?></a>
                                        </li>
                                        <li id="directli"><a data-toggle="tab" href="#tab-2" aria-expanded="true"
                                                             style='border-radius:none; margin-right:0px;'
                                                             onClick="javascript: phoneShow()"><?php echo L('短信注册'); ?></a>
                                        </li>
                                    </ul>
                                </div>
                                <?php
                            ...
                            <div id="mail_show">
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('邮箱'); ?><font
                                                color=red>*</font>：</label>
                                    <input value="" id="n_email" name="n_email"
                                           class="form-control<?php if (in_array("email", $must_reg_field)) {
                                               echo ' required';
                                           } ?>" type="email" placeholder="<?php echo L('请输入您的邮箱'); ?>">
                                </div>
                            </div>
                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <input value="" id="phone" name="phone" class="form-control valid" type="text"
                                       placeholder="<?php echo L('请输入您的手机号'); ?>">
                            </div>
                            <?php
                            //}
                            if (1 == 2 && $check_phone_code == 1) {
                                ...
                                <div id='phone_show' style="display:none">
                                    <div class="form-group">
                                        <label class="control-label"><?php echo L('手机验证码'); ?><font
                                                    color=red>*</font>：</label>
                                        <div class="col-sm-2">
                                            <input id="phone_code_verify" name="phone_code_verify"
                                                   class="form-control valid" type="text"
                                                   placeholder="<?php echo L('请输入图片验证码'); ?>"
                                                   aria-required="true" aria-invalid="false">
                                        </div>
                                        <img src="{:U('Public/verify')}" id="reg_phone_codeimg"/>
                                        <input class="btn btn-primary" type="button" id="getcode"
                                               value="<?php echo L('获取验证码'); ?>"/>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label"></label>
                                        <div class="col-sm-2">
                                            <input id="phone_code" name="phone_code" class="form-control valid"
                                                   type="text" placeholder="<?php echo L('请输入手机验证码'); ?>"
                                                   aria-required="true" aria-invalid="false">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input id="email" name="email"
                                               remote="{:U('Public/checkreg',array('mtserver'=>$mt4server['id']))}"
                                               class="form-control" type="email"
                                               placeholder="<?php echo L('请输入您的邮箱'); ?>">
                                    </div>
                                </div>
                                <?php
                            }
                            if (in_array('nickname', $reg_fields)) {
                                ...
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('英文名'); ?><?php if (in_array("nickname", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input value="" id="nickname" name="nickname" class="form-control valid" type="text"
                                           placeholder="<?php echo L('请输入您的姓名拼音'); ?>" <?php if (in_array("nickname", $must_reg_field)) {
                            ...
                            <div class="form-group">
                                ...
                                <input value="" id="password" name="password" rangelength="[6,12]" class="form-control"
                                       placeholder="<?php echo L('请输入您的登录密码'); ?>" type="password">
                            </div>
                            <div class="form-group">
                                <label class="control-label"><?php echo L('确认密码'); ?><font
                                            color=red>*</font>：</label>
                                <input type="hidden">
                                <input style="display:none">
                                <input value="" id="confirm" name="confirm" rangelength="[6,12]" class="form-control"
                                       type="password" placeholder="<?php echo L('请再次输入您的密码'); ?>">
                            </div>
                            <?php
                            if (in_array('chineseName', $reg_fields)) {
                                ...
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('中文名'); ?><?php if (in_array("chineseName", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input id="chineseName" name="chineseName" class="form-control"
                                           placeholder="<?php echo L('请输入您的中文名称'); ?>" type="text">
                                </div>
                                <?php
                            }
                            if (in_array('account_type', $reg_fields) && $typelist) {
                                ...
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('账户类型'); ?><?php if (in_array("account_type", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                            ...
                            <div class="form-group">
                                <label class="control-label"><?php echo L('国籍'); ?><?php if (in_array("nationality", $must_reg_field)) {
                                        echo '<font color=red>*</font>';
                                    } ?>：</label>
                                <select class="form-control m-b" id="nationality"
                                        name="nationality"><?php write_country_option(); ?></select>
                            ...
                            <div class="form-group">
                                <label class="control-label"><?php echo L('居住地'); ?><?php if (in_array("birthCountry", $must_reg_field)) {
                                        echo '<font color=red>*</font>';
                                    } ?>：</label>
                                <select class="form-control m-b" id="birthCountry"
                                        name="livingState"><?php write_country_option(); ?></select>
                                <script>document.getElementById('birthCountry').value = '<?php echo $ConfigItem['Reg_DefaultCity'];?>';</script>
                            </div>
                            <div class="form-group">
                                <label class="control-label"><?php echo L('省份'); ?><?php if (in_array("province", $must_reg_field)) {
                                        echo '<font color=red>*</font>';
                                    } ?>：</label>
                                <input id="province" name="province"
                                       placeholder="<?php echo L('请输入您所在的省份'); ?>"
                                       class="form-control<?php if (in_array("province", $must_reg_field)) {
                                           echo ' required';
                                       } ?>" type="text">
                            </div>
                            <?php
                            if (in_array('city', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('城市'); ?><?php if (in_array("city", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input id="city" name="city" placeholder="<?php echo L('请输入您所在的城市'); ?>"
                           ...
                           <div class="form-group">
                            ...
                            if (in_array('bankName', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('开户支行名称'); ?><?php if (in_array("bankName", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input id="bankName" name="bankName" class="form-control"
                                           placeholder="<?php echo L('请输入您的收款银行及支行名称：例如：XX银行XX省XX市XX支行'); ?>"
                                           type="text">
                                </div>
                                <?php
                            }
                            if (in_array('accountName', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('银行开户姓名'); ?><?php if (in_array("accountName", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input id="accountName" name="accountName"
                                           placeholder="<?php echo L('请输入您的收款人姓名'); ?>" class="form-control"
                                           type="text">
                                </div>
                                <?php
                            }
                            if (in_array('accountNum', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('银行账号'); ?><?php if (in_array("accountNum", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input id="accountNum" name="accountNum"
                                           placeholder="<?php echo L('请输入您的银行账号'); ?>" class="form-control"
                                           type="text">
                                </div>
                                <?php
                            }
                            if (in_array('bankCard', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('银行卡照片'); ?><?php if (in_array("bankCard", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <a id="btnUp1" style="padding:4px 10px;" class="btnsubmit btn btn-info btn-black-cz"
                                       href="#nolink"><?php echo L('选择图片'); ?></a>
                                    <div id="imglist1"></div>
                                    <input id="bankCard" name="bankCard" type="text" size="0"
                            ...
                            if (in_array('swiftCode', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('银行国际代码'); ?><?php if (in_array("swiftCode", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input id="swiftCode" name="swiftCode"
                                           placeholder="<?php echo L('请输入您的银行国际代码'); ?>" class="form-control"
                                           type="text">
                                </div>
                                <?php
                            }
                            if (in_array('realname', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('真实姓名'); ?><?php if (in_array("realname", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input id="realname" name="realname"
                                           placeholder="<?php echo L('请输入您证件的真实姓名'); ?>" class="form-control"
                                           type="text">
                                </div>
                                <?php
                            }
                            if (in_array('identity', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('证件号码'); ?><?php if (in_array("identity", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input id="identity" name="identity"
                                           placeholder="<?php echo L('请输入您的证件号码'); ?>" class="form-control"
                                           type="text">
                                </div>
                                <?php
                            }
                            if (in_array('identityOpposite', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('身份证正面照'); ?><?php if (in_array("identityOpposite", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <a id="btnUp2" style="padding:4px 10px;" class="btnsubmit btn btn-info btn-black-cz"
                                       href="#nolink"><?php echo L('选择图片'); ?></a>
                                    <input id="identityOpposite" name="identityOpposite" type="text" size="0"
                                           style="height: 0;width: 0;border: 0;">
                                    <div id="imglist2"></div>
                                </div>
                                <?php
                            ...
                            if (in_array('identityBack', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('身份证反面照'); ?><?php if (in_array("identityBack", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <a id="btnUp3" style="padding:4px 10px;" class="btnsubmit btn btn-info btn-black-cz"
                                       href="#nolink"><?php echo L('选择图片'); ?></a>
                                    <input id="identityBack" name="identityBack" type="text" size="0"
                                           style="height: 0;width: 0;border: 0;">
                                    <div id="imglist3"></div>
                                </div>
                                <?php
                            ...
                            if (in_array('addressProof', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('地址证明'); ?><?php if (in_array("addressProof", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <a id="btnUp4" style="padding:4px 10px;" class="btnsubmit btn btn-info btn-black-cz"
                                       href="#nolink"><?php echo L('选择图片'); ?></a>
                                    <input id="addressProof" name="addressProof" type="text" size="0"
                                           style="height: 0;width: 0;border: 0;">
                                    <div id="imglist4"></div>
                                </div>
                                <?php
                            ...
                            if (in_array('register_invent_codes', $reg_fields)) {
                                ?>
                                <div class="form-group">
                                    <label class="control-label"><?php echo L('推荐码'); ?><?php if (in_array("register_invent_codes", $must_reg_field)) {
                                            echo '<font color=red>*</font>';
                                        } ?>：</label>
                                    <input id="register_invent_codes" name="register_invent_codes"
                                           value="<?php echo $inventCode; ?>"
                                           placeholder="<?php echo L('请填写推荐码'); ?>"
                                           class="form-control <?php if (in_array("register_invent_codes", $must_reg_field)) {
                                               echo ' required';
                                           } ?>" type="text">
                                </div>
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <input id="phone_code_verify" name="phone_code_verify" value=""
                                       placeholder="<?php echo L('请输入图片验证码'); ?>" class="form-control required"
                                       type="text">
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <div style="margin-top:10px;">
                                                <input type="checkbox" class="checkbox" id="agree" name="agree"
                                                       value="1" style="display:inline-block;"> <label
                                                        for="agree"><?php echo L('我本人知晓和同意上述所有条款'); ?></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-0 text-center">
                                <button class="btn btn-primary" type="submit"
                                        id="regiestbtn"><?php echo L('提交注册'); ?></button>
                            </div>
                        </form>
...
<script>
    ...
    $(document).on("click", "#getmailcode", function () {
        ...
        mailtime(this);
        $.post('{:U("Public/sendmailactivemsg")}', {
            email: email,
            mtserver: mtserver,
            imgcode: imgcode
        }, function (data) {
