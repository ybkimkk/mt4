        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-sm-4">
                            <a href="#nolink" id="addpay" data-target="#myModal" class="btn btn-danger mb-2"><i
                                        class="mdi mdi-plus-circle mr-2"></i> <?php echo L('添加币种'); ?></a>
                        </div>
                    </div>
                    <table id="basic-datatable" class="table dt-responsive nowrap table-hover" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="no-sort"><?php echo L('通道编码'); ?></th>
        ...
        <div class="modal-content animated bounceInRight">
            ...
            <form id='addform' name='addform'>
                ...
                <div class="modal-body">
                    ...
                    <label><?php echo L('通道代码'); ?>：</label>
                    <div class="input-group mb-2">
                        <input type="text" class="form-control" name="channel_type" id="channel_type">
                    </div>
                    <!--
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-white closeout"
                            data-dismiss="modal"><?php echo L('关闭'); ?></button>
...
<script>
    ...
    $(document).on("click", ".forbidenreopen", function () {
        ...
        layer.confirm("<?php echo L('您确定要'); ?>" + txtbtn + "<?php echo L('这条信息吗'); ?>", {
