...
class ChuanglanSmsApi {
    ...
    public function __construct() {
        $this->chuanglan_config['api_send_url'] = 'https://sms.253.com/msg/send';

//创蓝变量短信接口URL, 如无必要，该参数可不用修改
        $this->chuanglan_config['API_VARIABLE_URL'] = 'https://sms.253.com/msg/send/json';

//创蓝短信余额查询接口URL, 如无必要，该参数可不用修改
        $this->chuanglan_config['api_balance_query_url'] = 'http://sms.253.com/msg/balance/json';
//创蓝账号 替换成你自己的账号
        $this->chuanglan_config['api_account'] = 'N1273342';

//创蓝密码 替换成你自己的密码
        $this->chuanglan_config['api_password'] = 'e13m4aWcEY01aa';
    }
